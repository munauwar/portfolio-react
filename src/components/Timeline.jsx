        ...
        <ol className="border-l border-gray-200 mt-5 ml-2">
          <li className="mb-10">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              className="w-6 h-6 ring-8 ring-white bg-blue-200 rounded-full ml-[-10px] mb-[-30px]"
            >
              <path
            ...
            <div className="p-4 bg-black rounded-lg ml-7">
              <div className="justify-between items-center mb-3 sm:flex">
                <time className="mb-1 text-xs font-normal text-red-700 sm:order-last sm:mb-0">
                  Latest
                </time>
                <div className="font-mono text-gray-500">
                  <span className="font-bold text-base text-white selection:text-red-700">
          ...
          <li className="mb-10">
            ...
            <div className="p-4 bg-black rounded-lg ml-7">
              ...
              <div className="p-3 text-base font-normal text-black bg-gray-400 rounded-lg border-black">
